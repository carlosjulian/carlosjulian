      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-white/30 text-sm max-w-xs mb-4">
              {staticProfile.tagline} | {staticProfile.venture.role} @ {staticProfile.venture.shortName}
            </p>
            {/* Social Links */}
            <div className="flex flex-wrap gap-3">
              ...
              <a href={staticProfile.socials.website} target="_blank" rel="noopener noreferrer" className="p-2 bg-white/[0.03] border border-white/[0.08] rounded-lg text-white/30 hover:text-white hover:border-white/20 transition-all" title="Website">
                <span className="text-sm">🌐</span>
              </a>
              <a href={staticProfile.socials.youtube} target="_blank" rel="noopener noreferrer" className="p-2 bg-white/[0.03] border border-white/[0.08] rounded-lg text-white/30 hover:text-white hover:border-white/20 transition-all" title="YouTube">
              ...
              <a href={staticProfile.socials.instagram} target="_blank" rel="noopener noreferrer" className="p-2 bg-white/[0.03] border border-white/[0.08] rounded-lg text-white/30 hover:text-white hover:border-white/20 transition-all" title="Instagram">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm">
          <p className="text-white/20 font-mono text-xs">
            &copy; {new Date().getFullYear()} <span className="text-white/30">Carlos</span> <span className="text-orange-500/50">Julián</span>
          </p>
